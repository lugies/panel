                        ...
                        foreach( $all as $row ){
                            ...
                            echo "<td>"; 
                               // $daterow = $row['musteriTeslim'];
                                $date = new DateTime($row['users_date']);
                                $now = new DateTime();
                                echo $date->diff($now)->format("%d gün, %h saat sonra teslim");
                            echo"</td>";
                            print "<td><a class='btn btn-outline-info btn-sm btn-lg btn-block' href='/admin/detay.html/". $row['users_id']."' role='button'>Detaylar</a></td>";
                            echo '</tr>';
                        }
                    ?>
